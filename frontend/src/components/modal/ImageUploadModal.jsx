    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        <h4 className="text-xl font-semibold text-center text-blue-600 mb-4">
          Upload Class Picture for Attendance
        </h4>
        <label
          htmlFor="file"
          className="flex flex-col justify-center items-center w-full h-48 border-2 border-dashed border-gray-300 text-gray-600 cursor-pointer hover:border-gray-400 hover:text-gray-800 mb-4"
        >
          <span>
            <svg
              xmlSpace="preserve"
        ...
        <button
          ...
          disabled={!image}
          className="w-full bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-teal-700 transition duration-300"
        >
          Upload Image
        </button>
        <button
